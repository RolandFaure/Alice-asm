...
void go_through_the_reads_again(std::string reads_file, std::string assemblyFile, int context_length, int compression, int km, robin_hood::unordered_map<std::string, std::pair<std::string,std::string>>& kmers, int num_threads, bool homopolymer_compression);
