...
Alice is a lightweight genomic and metagenomic assembler designed for HiFi reads (<0.1% error rate). Alice can be an order of magnitude faste than assemblers such as hifiasm, metaMDBG, myloasm and (meta)Flye... 
