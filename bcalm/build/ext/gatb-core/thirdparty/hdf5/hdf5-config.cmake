...
# Directories
#-----------------------------------------------------------------------------
set (${HDF5_PACKAGE_NAME}_INCLUDE_DIR "/home/rfaure/Documents/these/MSR/wonderasm/bcalm/build/ext/gatb-core/include//hdf5" "${${HDF5_PACKAGE_NAME}_MPI_C_INCLUDE_DIRS}")

set (${HDF5_PACKAGE_NAME}_SHARE_DIR "${PACKAGE_PREFIX_DIR}//home/rfaure/Documents/these/MSR/wonderasm/bcalm/build/ext/gatb-core/share/")
set_and_check (${HDF5_PACKAGE_NAME}_BUILD_DIR "${PACKAGE_PREFIX_DIR}")

if (${HDF5_PACKAGE_NAME}_BUILD_CPP_LIB)
  set (${HDF5_PACKAGE_NAME}_INCLUDE_DIR_CPP "/home/rfaure/Documents/these/MSR/wonderasm/bcalm/build/ext/gatb-core/include//hdf5")
endif ()

if (${HDF5_PACKAGE_NAME}_BUILD_HL_LIB)
  set (${HDF5_PACKAGE_NAME}_INCLUDE_DIR_HL "/home/rfaure/Documents/these/MSR/wonderasm/bcalm/build/ext/gatb-core/include//hdf5")
endif ()

if (${HDF5_PACKAGE_NAME}_BUILD_HL_LIB AND ${HDF5_PACKAGE_NAME}_BUILD_CPP_LIB)
  set (${HDF5_PACKAGE_NAME}_INCLUDE_DIR_HL_CPP "/home/rfaure/Documents/these/MSR/wonderasm/bcalm/build/ext/gatb-core/include//hdf5")
endif ()

if (${HDF5_PACKAGE_NAME}_BUILD_TOOLS)
  set (${HDF5_PACKAGE_NAME}_INCLUDE_DIR_TOOLS "/home/rfaure/Documents/these/MSR/wonderasm/bcalm/build/ext/gatb-core/include//hdf5")
...
if (NOT TARGET "hdf5")
  if (${HDF5_PACKAGE_NAME}_ENABLE_Z_LIB_SUPPORT AND ${HDF5_PACKAGE_NAME}_PACKAGE_EXTLIBS AND NOT TARGET "zlib")
    include (${PACKAGE_PREFIX_DIR}//home/rfaure/Documents/these/MSR/wonderasm/bcalm/build/ext/gatb-core/share///-targets.cmake)
  endif ()
  if (${HDF5_PACKAGE_NAME}_ENABLE_SZIP_SUPPORT AND ${HDF5_PACKAGE_NAME}_PACKAGE_EXTLIBS AND NOT TARGET "szip")
    include (${PACKAGE_PREFIX_DIR}//home/rfaure/Documents/these/MSR/wonderasm/bcalm/build/ext/gatb-core/share///-targets.cmake)
  endif ()
  include (${PACKAGE_PREFIX_DIR}//home/rfaure/Documents/these/MSR/wonderasm/bcalm/build/ext/gatb-core/share//hdf5/hdf5-targets.cmake)
endif ()
...
foreach (comp IN LISTS ${HDF5_PACKAGE_NAME}_FIND_COMPONENTS)
  if (${comp} STREQUAL "shared")
    ...
    if (${HDF5_PACKAGE_NAME}_BUILD_FORTRAN)
      set (${HDF5_PACKAGE_NAME}_INCLUDE_DIR_FORTRAN "/home/rfaure/Documents/these/MSR/wonderasm/bcalm/build/ext/gatb-core/include//hdf5/shared")
    endif ()
  elseif (${comp} STREQUAL "static")
    ...
    if (${HDF5_PACKAGE_NAME}_BUILD_FORTRAN)
      set (${HDF5_PACKAGE_NAME}_INCLUDE_DIR_FORTRAN "/home/rfaure/Documents/these/MSR/wonderasm/bcalm/build/ext/gatb-core/include//hdf5/static")
    endif ()
  endif ()
endforeach ()
